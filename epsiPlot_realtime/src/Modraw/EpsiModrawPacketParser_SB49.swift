...
class EpsiModrawPacketParser_SB49 : EpsiModrawPacketParser {
    ...
    override func parse(header: String) {
        sbe_cal_ta0 = getKeyValueDouble(key: "\nTA0=", header: header)
        sbe_cal_ta1 = getKeyValueDouble(key: "\nTA1=", header: header)
        sbe_cal_ta2 = getKeyValueDouble(key: "\nTA2=", header: header)
        sbe_cal_ta3 = getKeyValueDouble(key: "\nTA3=", header: header)
        sbe_cal_pa0 = getKeyValueDouble(key: "\nPA0=", header: header)
        sbe_cal_pa1 = getKeyValueDouble(key: "\nPA1=", header: header)
        sbe_cal_pa2 = getKeyValueDouble(key: "\nPA2=", header: header)
        sbe_cal_ptempa0 = getKeyValueDouble(key: "\nPTEMPA0=", header: header)
        sbe_cal_ptempa1 = getKeyValueDouble(key: "\nPTEMPA1=", header: header)
        sbe_cal_ptempa2 = getKeyValueDouble(key: "\nPTEMPA2=", header: header)
        sbe_cal_ptca0 = getKeyValueDouble(key: "\nPTCA0=", header: header)
        sbe_cal_ptca1 = getKeyValueDouble(key: "\nPTCA1=", header: header)
        sbe_cal_ptca2 = getKeyValueDouble(key: "\nPTCA2=", header: header)
        sbe_cal_ptcb0 = getKeyValueDouble(key: "\nPTCB0=", header: header)
        sbe_cal_ptcb1 = getKeyValueDouble(key: "\nPTCB1=", header: header)
        sbe_cal_ptcb2 = getKeyValueDouble(key: "\nPTCB2=", header: header)
        sbe_cal_cg = getKeyValueDouble(key: "\nCG=", header: header)
        sbe_cal_ch = getKeyValueDouble(key: "\nCH=", header: header)
        sbe_cal_ci = getKeyValueDouble(key: "\nCI=", header: header)
        sbe_cal_cj = getKeyValueDouble(key: "\nCJ=", header: header)
        sbe_cal_ctcor = getKeyValueDouble(key: "\nCTCOR=", header: header)
        sbe_cal_cpcor = getKeyValueDouble(key: "\nCPCOR=", header: header)
        PCodeData_lat = getKeyValueDouble(key: "\nPCodeData.lat =", header: header)
    }
